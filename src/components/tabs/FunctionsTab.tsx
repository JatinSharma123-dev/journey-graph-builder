...
const FunctionsTab: React.FC = () => {
  ...
  const [extraFieldKeys, setExtraFieldKeys] = useState<{
    [key: string]: string;
  }>({});
  const [inputPropertyKeys, setInputPropertyKeys] = useState<{
    [key: string]: string;
  }>({});
  const [outputPropertyKeys, setOutputPropertyKeys] = useState<{
    [key: string]: string;
  }>({});
  ...
  const handleEdit = (func: Function) => {
    ...
    const { host, path, method, header_params, headers, ...extraFields } =
      func.config;
    setFormData({
      name: func.name,
      type: func.type,
  ...
  const handleHeaderTypeChange = (
    ...
    // If switching to properties, clear value
    if (type === "properties") {
      setFormData((prev) => ({
        ...prev,
        config: {
  ...
  const handleHeaderPropertyValueChange = (key: string, propertyId: string) => {
    setFormData((prev) => ({
      ...prev,
      config: {
        ...prev.config,
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="mt-4">
                  ...
                  <div className="space-y-2">
                    {Object.entries(formData.config.header_params).map(
                      ([key, value]) => (
                        <div key={key} className="flex gap-2">
                          <input
                            ...
                            onChange={(e) =>
                              handleHeaderParamKeyChange(key, e.target.value)
                            }
                          ...
                          <input
                            ...
                            value={value}
                            onChange={(e) =>
                              updateHeaderParamField(key, e.target.value)
                            }
                            className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div className="mt-4">
                  ...
                  <div className="space-y-2">
                    {Object.entries(formData.config.headers).map(
                      ([key, value]) => (
                        <div key={key} className="flex gap-2">
                          <input
                            type="text"
                            value={headerKeys[key] ?? key}
                            onChange={(e) =>
                              handleHeaderKeyChange(key, e.target.value)
                            }
                          ...
                          />
                          <select
                            value={headerTypes[key] ?? "custom"}
                            onChange={(e) =>
                              handleHeaderTypeChange(
                                key,
                                e.target.value as "custom" | "properties"
                              )
                            }
                          ...
                          {headerTypes[key] === "custom" ? (
                            ...
                            <select
                              value={value}
                              onChange={(e) =>
                                handleHeaderPropertyValueChange(
                                  key,
                                  e.target.value
                                )
                              }
            ...
            {formData.config.method === "POST" && (
              <>
                <div className="mt-4">
                  ...
                  <div className="space-y-2">
                    {Object.entries(formData.config.extraFields).map(
                      ([key, value]) => (
                        <div key={key} className="flex gap-2">
                          <input
                            type="text"
                            ...
                            onChange={(e) =>
                              handleExtraFieldKeyChange(key, e.target.value)
                            }
                          ...
                          <input
                            ...
                            value={value}
                            onChange={(e) =>
                              updateExtraField(key, e.target.value)
                            }
                            className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            ...
            <div className="border-t pt-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <div className="space-y-2">
                        {Object.entries(formData.input_properties).map(
                          ([key, value]) => (
                            <div key={key} className="flex gap-2">
                              <input
                                type="text"
                              ...
                              <input
                                ...
                                value={value}
                                onChange={(e) =>
                                  updateInputProperty(key, e.target.value)
                                }
                                className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {Object.entries(formData.output_properties).map(
                          ([key, value]) => (
                            <div key={key} className="flex gap-2">
                              <input
                                type="text"
                              ...
                              <input
                                ...
                                value={value}
                                onChange={(e) =>
                                  updateOutputProperty(key, e.target.value)
                                }
                                className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-gray-600 mb-2">
                      <span className="font-medium">{func.config.method}</span>{" "}
                      {func.config.host}
                      {func.config.path}
                    </div>
                    <div className="flex gap-4 text-sm text-gray-500">
                      <span>
                        Header Params:{" "}
                        {Object.keys(func.config.header_params).length}
                      </span>
                      <span>
                        Inputs: {Object.keys(func.input_properties).length}
                      </span>
                      <span>
                        Outputs: {Object.keys(func.output_properties).length}
                      </span>
                    </div>
                  </div>
